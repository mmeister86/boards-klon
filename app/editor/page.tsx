...
export default function EditorPage() {
  ...
  const { previewMode, loadProject, currentProjectTitle, setProjectTitle, isLoading, createNewProject } =
    useBlocksStore()
  ...
  const [manuallyCreatedProject, setManuallyCreatedProject] = useState<string | null>(null)
      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex-1 flex items-center justify-center bg-muted">
          <div className="bg-card p-8 rounded-lg shadow-lg max-w-md">
            <h2 className="text-xl font-bold text-destructive mb-4">Error Loading Project</h2>
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <ViewportProvider>
        <div className="flex flex-col h-screen">
          <Navbar currentView="editor" projectTitle={currentProjectTitle} onTitleChange={setProjectTitle} />
