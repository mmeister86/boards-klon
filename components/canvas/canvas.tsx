...
export default function Canvas() {
  ...
  const filteredDropAreas = dropAreas.filter((area, index) => {
    ...
    const isPrevEmpty = dropAreas[index - 1].blocks.length === 0 && !dropAreas[index - 1].isSplit
  ...
  return (
    <div className="flex-1 bg-muted overflow-auto p-6" onClick={handleCanvasClick}>
      ...
      <div className={`mx-auto ${viewport === "desktop" ? "w-[90%]" : "w-auto"} flex justify-center`}>
        <div
